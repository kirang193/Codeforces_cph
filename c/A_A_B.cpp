...
void generateRandomBoard(int board[][N], int* state)
{
...
bool compareStates(int* A, int* B)
{
	for (int i = 0; i < N; i++) {
		if (A[i] != B[i])
			return false;
...
int main()
{
	...
	generateRandomBoard(board, state);
